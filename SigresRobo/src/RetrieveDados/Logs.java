...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Sigres/Log/ProvisaoBaixa/RetrieveDados/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Sigres/Log/ProvisaoBaixa/RetrieveDados/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler("C:/Automatizacao/Sigres/Log/ProvisaoBaixa/RetrieveDados/RetrieveDados@" + Logs.Data() + ".txt");
