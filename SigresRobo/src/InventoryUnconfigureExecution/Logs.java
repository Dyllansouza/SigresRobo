...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Sigres/Log/ProvisaoBaixa/InventoryUnconfigureExecution/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Sigres/Log/ProvisaoBaixa/InventoryUnconfigureExecution/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler(
					"C:/Automatizacao/Sigres/Log/ProvisaoBaixa/InventoryUnconfigureExecution/InventoryUnconfigureExecution@" + Logs.Data() + ".txt");
