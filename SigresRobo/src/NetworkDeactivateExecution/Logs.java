...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Sigres/Log/ProvisaoBaixa/NetworkDeactivateExecution/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Sigres/Log/ProvisaoBaixa/NetworkDeactivateExecution/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler(
					"C:/Automatizacao/Sigres/Log/ProvisaoBaixa/NetworkDeactivateExecution/NetworkDeactivateExecution@" + Logs.Data() + ".txt");
