...
public class Logs {
	...
	final static String sucessoPath = "C:/Automatizacao/Sigres/Log/AlteracaoPedido/AlterProfileServiceRollback/SUCESSO/";
	final static String erroPath = "C:/Automatizacao/Sigres/Log/AlteracaoPedido/AlterProfileServiceRollback/ERRO/";
	...
	public static java.util.logging.Logger Logger() {
		...
		try {
			...
			fh = new FileHandler(
					"C:/Automatizacao/Sigres/Log/AlteracaoPedido/AlterProfileServiceRollback/AlterProfileServiceRollback@" + Logs.Data() + ".txt");
